...
layersloop = ['inception_4c/output', 'inception_5b/output', 
              'inception_4e/output', 'inception_5b/pool_proj',
              'inception_5a/output', 'inception_5b/pool_proj',
              'inception_4d/output', 'inception_4d/pool_proj',
              'inception_4c/output', 'inception_5a/5x5']
...
def main(input, output, image_type, gpu, model_path, model_name, preview, octaves, octave_scale, iterations, jitter, zoom, stepsize, blend, layers, guide_image, start_frame, end_frame, verbose):
    ...
    net = caffe.Classifier('tmp.prototxt', param_fn,
                           mean = np.float32([121.0, 121.0, 121.0]), # ImageNet mean, training set dependent
